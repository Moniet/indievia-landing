  ...
  return (
    <div className="flex-1 py-12 pr-5 pl-0">
      <div className="flex justify-between">
        <div>
          <div className="">Help And Support</div>
          <div className="text-sm text-white/50 mb-10">
            In-app support tickets raised by professionals.
          </div>
        </div>
        <Select onValueChange={(s) => setStatus(s)} defaultValue="open">
          <SelectTrigger
            className="min-w-fit w-fit border-none bg-white/10 px-5 rounded-full"
            value={status}
            defaultValue={"open"}
          >
      ...
      <div className="flex flex-col max-w-[750px] gap-5">
        {isLoading && (
          <>
            <CardSkeleton />
            <CardSkeleton />
